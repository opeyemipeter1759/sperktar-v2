    ...
    <div className="relative flex min-h-screen w-full flex-col items-center overflow-x-hidden p-4 sm:p-6 md:p-8">
      ...
      <div className="w-full max-w-4xl py-16 sm:py-24">
        ...
        <p className="text-lg text-secondary-text leading-relaxed">
          Crafting intuitive, user-centric and beautiful digital experiences. We focus on creating a seamless and engaging user experience that looks beautiful and functions flawlessly.
        </p>
        {/* Add more detailed content about your UX/UI design services here */}
      </div>
    </div>
  );
}
