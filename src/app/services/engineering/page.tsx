    ...
    <div className="relative flex min-h-screen w-full flex-col items-center overflow-x-hidden p-4 sm:p-6 md:p-8">
      ...
      <div className="w-full max-w-4xl py-16 sm:py-24">
        ...
        <p className="text-lg text-secondary-text leading-relaxed">
          Building robust, scalable, and secure software architectures. Our developers turn designs into high-performance, secure, and scalable applications.
        </p>
        {/* Add more detailed content about your engineering services here */}
      </div>
    </div>
  );
}
