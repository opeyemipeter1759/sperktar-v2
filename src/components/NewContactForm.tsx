...
const NewContactForm = () => {
  ...
  if (submitted) {
    return (
      <div className="text-center py-12">
        ...
        <p className="mt-3 text-lg text-secondary-text max-w-2xl mx-auto">We've received your request. A member of our team will reach out to you shortly.</p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-y-6">
      ...
      <div>
        <label htmlFor="message" className="block text-sm font-medium text-gray-300">Tell us more</label>
        <div className="mt-1">
          <textarea
            id="message"
            name="message"
      ...
      <div>
        <button
          type="submit"
          className="group relative flex w-full cursor-pointer items-center justify-center overflow-hidden rounded-full h-14 px-10 bg-primary hover:bg-primary-hover transition-all duration-300 shadow-[0_0_20px_rgba(6,182,212,0.4)] hover:shadow-[0_0_30px_rgba(6,182,212,0.6)]"
        >
          <span className="relative z-10 text-white text-lg font-bold tracking-wide uppercase">Submit</span>
